...
def main(args):
    # Step 1: Load dataset
    # poison train data
    trans_train, trans_label_train = get_trans(args.data, 32, train=True)
    trans_test, trans_label_test = get_trans(args.data, 32, train=False)
    ...
    for epoch in range(args.num_epoch):
        net.set_train()
        for data, label in train.create_tuple_iterator():
        ...
        train_acc = test(net, eval_data, ls)
